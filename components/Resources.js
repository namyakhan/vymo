...
const Resources = () => {
  return (
    <div id="resources" className="container mx-auto py-[10px] px-[10px] lg:px-[50px] pt-16 lg:pt-32 mb-10">
      <div className="flex flex-col items-center text-center lg:flex lg:flex-row lg:items-center lg:justify-between lg:text-left">
